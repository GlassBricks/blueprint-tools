...
class Oracle : MutableSpatialDataStructure<SimpleSpatial>,
    ...
    override fun occupiedTiles(): Sequence<TilePosition> =
        asSequence().flatMap { it.allOccupiedTiles().asSequence() }.distinct()
}
...
class SpatialTileHashMapTest {
    ...
    fun getOccupiedTiles() {
        addRandom()
        removeHalf()
        assertMatches(oracle.occupiedTiles(), testee.occupiedTiles())
    }
