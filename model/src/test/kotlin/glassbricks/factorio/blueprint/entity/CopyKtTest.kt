...
class CopyKtTest {
    ...
    fun `can copy basic entity`() {
        val entity = VanillaPrototypes.createBpEntity("iron-chest", Position.ZERO) as Container
        entity.bar = 3
    ...
    private fun createPole(): ElectricPole {
        return VanillaPrototypes.createBpEntity("small-electric-pole", Position.ZERO) as ElectricPole
    }
    ...
    fun `can copy cable connection point`() {
        ...
        val chest1 = VanillaPrototypes.createBpEntity("iron-chest", Position.ZERO) as Container
    ...
    fun `can copy power switch connections`() {
        val powerSwitch = VanillaPrototypes.createBpEntity("power-switch", Position.ZERO) as PowerSwitch
        val pole1 = createPole()
        val pole2 = createPole()
    ...
    fun `can copy combinator connections`() {
        val combinator =
            VanillaPrototypes.createBpEntity("arithmetic-combinator", Position.ZERO) as ArithmeticCombinator
        val pole1 = createPole()
        val pole2 = createPole()
    ...
    fun `can copy multiple basic entities`() {
        val entity1 = VanillaPrototypes.createBpEntity("iron-chest", Position.ZERO) as Container
    ...
    fun `can copy multiple entities with connections`() {
        ...
        val pole2 = createPole()
        val chest1 = VanillaPrototypes.createBpEntity("iron-chest", Position.ZERO) as Container
        val chest2 = VanillaPrototypes.createBpEntity("iron-chest", Position.ZERO) as Container
