...
class Oracle : MutableSpatialDataStructure<SimpleSpatial>,
    ...
    override fun getIntersectingPosition(position: Position): Sequence<SimpleSpatial> =
...
class TileHashMapTest {
    ...
    fun testQueryPoint() {
        ...
        for (i in 0 until 10) {
            ...
            assertMatches(oracle.getIntersectingPosition(point), testee.getIntersectingPosition(point))
        }
    }
