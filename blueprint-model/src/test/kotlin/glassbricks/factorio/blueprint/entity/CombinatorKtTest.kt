...
class CombinatorKtTest {
    ...
    fun `can save load arithmetic combinators`() {
        ...
        testSaveLoad(ArithmeticCombinator::class, "arithmetic-combinator", null, false) {
    ...
    fun `can save load decider combinators`() {
        ...
        testSaveLoad(DeciderCombinator::class, "decider-combinator", null, false) {
            control_behavior = ControlBehaviorJson(
    ...
    fun `can save load constant combinators`() {
        ...
        testSaveLoad(ConstantCombinator::class, "constant-combinator", null, false) {
            control_behavior = ControlBehaviorJson(
                is_on = false,
                filters = listOf(
